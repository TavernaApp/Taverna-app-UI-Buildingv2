...
import MapBarPage from './MapBarPage';

const MapBarDetailScreen = ({ userData }) => {
    ...
    const renderBarImage = () => {
        if (selectedBar && selectedBar.photos && selectedBar.photos.length > 0) {
            const photoReference = selectedBar.photos[0].photo_reference;
...
export default connect(mapStateToProps)(MapBarDetailScreen);
