...
import MyProfileBarPage from './MyProfileBarPage';
import HomeBarPage from './HomeBarPage';

const MyProfileBarDetailScreen = ({ userData }) => {
...
export default connect(mapStateToProps)(MyProfileBarDetailScreen);
