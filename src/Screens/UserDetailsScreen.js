...
// const UserDetailsScreen = ({ route, userData }) => {
//   const [following, setFollowing] = useState([]);
//   const [currentUserFollowing, setCurrentUserFollowing] = useState([]);
//   const [loading, setLoading] = useState(false);
//   const [followerCount, setFollowerCount] = useState(0);
//   const [followingCount, setFollowingCount] = useState(0);
//   const [friendFollowsYou, setFriendFollowsYou] = useState(false); // New state to track if friend follows the user
...
//           axios.get(`${BASE_URL}/api/users/getfollowerandfollowing/${friend?.id}`, {
//             headers: { Authorization: `Bearer ${userData?.token}` }
//           }),
//           axios.get(`${BASE_URL}/api/users/getfollowerandfollowing/${userData?.user?.id}`, {
//             headers: { Authorization: `Bearer ${userData?.token}` }
//           })
//         ]);
...
//           // Check if friend follows the current user
//           const followsYou = friendResponse.data.followers.some(follower => follower.id === userData.user.id);
//           setFriendFollowsYou(followsYou);
//         }
//       } catch (error) {
...
//   const handleGoBack = () => {
//     navigation.navigate('SearchScreenBottomBar');
//   };

//   const handleShowFollowers = () => {
//     navigation.navigate('FriendFollow', { friend });
//   };

//   const handleShowFollowing = () => {
//     navigation.navigate('FriendFollowing', { friend });
//   };
...
//             {isFollowing(friend.id) ? 'Following' : (friendFollowsYou ? 'Follow' : 'Follow Back')}
//           </Text>
//         </TouchableOpacity>
//       )}
