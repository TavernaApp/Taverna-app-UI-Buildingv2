...
import CrawlDetailBarPage from './CrawlDetailBarPage';

const CrawlDetailBarDetailScreen = ({ userData }) => {
...
export default connect(mapStateToProps)(CrawlDetailBarDetailScreen);
