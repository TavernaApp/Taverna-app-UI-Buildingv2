  ...
  const MyMapScreen = ({ navigation, route }) => {
    const { location } = route.params || {}; // Fallback to an empty object// Fallback to an empty object
 ...
 useEffect(()=>{
  fetchUserLocation();
      ...
      useEffect(() => {
        return () => {
            navigation.setParams({ location: null }); // Reset location to null or {} or any initial state
        };
    }, [navigation]);
      ...
      >
        ...
        <View style={{ flex: 1 }}>
          <View style={styles.topBarButtonRecentActivity}>
            ...
            <TouchableOpacity onPress={handleGoBack} style={styles.topBarButtonAlignmentRecentActivity}>
              <Text style={styles.topBarButtonTextRecentActivity}>My Map</Text>
            </TouchableOpacity>
          </View>
          {region && (
            <MapView
          ...
          <View style={styles.zoomControls}>
            ...
            <TouchableOpacity style={styles.zoomButton} onPress={handleRefresh}>
