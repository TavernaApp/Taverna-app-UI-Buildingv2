...
import { View, Text, TouchableOpacity, Image, Modal, ScrollView, Alert,Linking} from 'react-native';
...
<TouchableOpacity style={styles.barpageplusButton} onPress={handlePlusReview}>
...
<View style={{borderBottomWidth: 1, borderBottomColor: "gray", marginVertical: 15}} />
{/* SLIDE UP SECTION */}
...
export default CrawlDetailBarPage;
